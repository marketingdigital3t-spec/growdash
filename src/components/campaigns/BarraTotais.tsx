...
export function BarraTotais({ rows, columns, scrollContainerRef }: { rows: CampaignLike[]; columns: CampaignTotalColumn[]; scrollContainerRef: RefObject<HTMLDivElement | null> }) {
  ...
  return <div ref={barRef} className="campaign-total-bar flex h-[68px] min-h-[68px] shrink-0 items-center overflow-hidden border-t border-primary/30" aria-label="Totais das campanhas filtradas">
