...
export function BarraTotais({ rows, columns, scrollContainerRef }: { rows: CampaignLike[]; columns: CampaignTotalColumn[]; scrollContainerRef: RefObject<HTMLDivElement | null> }) {
  ...
  return <div ref={barRef} className="campaign-total-bar block h-16 min-h-16 shrink-0 overflow-hidden border-t border-primary/30" aria-label="Totais das campanhas filtradas">
