          ...
          {NAV.map(({ label, icon: Icon, action }) => (
            <li key={label}>
              <button
                ...
                className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-neutral-300 transition-colors hover:bg-white/5"
              >
              ...
              return (
                <li key={t.id} className="group relative">
                  ...
                  <button
                    ...
                    className={cn(
                      "absolute right-1.5 top-1/2 -translate-y-1/2 rounded p-1 text-neutral-500 opacity-0 transition-opacity hover:bg-white/10 hover:text-neutral-100 group-hover:opacity-100",
                    )}
                  >
      ...
      <div className="border-t border-white/5 px-3 py-3">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="text-[11px] text-neutral-500">Interface local</div>
          </div>
        </div>
      </div>
    </aside>
