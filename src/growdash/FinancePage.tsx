...
import { addMonths, eachDayOfInterval, eachMonthOfInterval, endOfMonth, format, startOfMonth, startOfWeek, subMonths } from "date-fns";
...
export default function FinancePage() {
  ...
  const cashFlow = useMemo(() => {
    ...
    return eachDayOfInterval({ start: startDate, end: endDate }).map((day) => {
      ...
      return { date, label: format(day, "dd/MM"), inflow, outflow, net: inflow - outflow, balance: runningBalance, movements };
    });
  }, [cashMovements, connectedBalance, endDate, financialTransactions.length, startDate]);
