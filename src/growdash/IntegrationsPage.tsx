    ...
    <div className="mx-auto max-w-[1500px]">
      ...
      <Tabs value={tab} onValueChange={(value) => setParams({ tab: value })} className="space-y-4">
        ...
        <TabsContent value="paid" className="space-y-4">
          ...
          <details className="gd-panel p-5"><summary className="cursor-pointer font-black">Atribuição, UTMs e métricas avançadas</summary><div className="mt-5 space-y-4"><IntegrationPanelGuard name="Padrão de UTMs"><UTMConventionCard /></IntegrationPanelGuard><IntegrationPanelGuard name="Mapeamento de UTMs"><UTMMappingCard /></IntegrationPanelGuard><IntegrationPanelGuard name="Plataformas e origens"><PlatformRulesSection /></IntegrationPanelGuard><IntegrationPanelGuard name="Métricas personalizadas"><CustomMetricsSection /></IntegrationPanelGuard></div></details>
