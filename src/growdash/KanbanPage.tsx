...
import { ArrowLeft, BriefcaseBusiness, CalendarDays, Check, CheckSquare2, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, ClipboardList, Columns3, Headphones, ImageUp, LayoutGrid, List, ListTodo, Megaphone, MessageSquare, MoveRight, Paperclip, Pencil, Plus, Search, Tag, Trash2, X } from "lucide-react";
...
const BOARD_TEMPLATES: BoardTemplate[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { column: "Acessos e tracking", title: "Enviar guia de liberação completa da Meta", description: "Passo a passo para o expert: 1) entrar no perfil administrador e selecionar o portfólio empresarial correto; 2) abrir business.facebook.com, ir em Configurações > Usuários > Pessoas; 3) clicar em Convidar pessoas; 4) convidar bertoldidesignerpro@gmail.com; 5) selecionar Acesso total; 6) atribuir conta de anúncios, Página do Facebook, Instagram, pixel/conjunto de dados, domínio e catálogo quando existirem; 7) revisar e enviar o convite oficial; 8) avisar que o convite foi enviado; 9) confirmar o aceite. Não compartilhar senha, código de autenticação ou login pessoal.", priority: "urgent" },
