...
export default function LifeSimPage() {
  ...
  useEffect(() => {
    ...
    const npcObjects: Array<{ id: string; root: THREE.Group; base: THREE.Vector3; halo: THREE.Mesh; leftArm: THREE.Group; rightArm: THREE.Group; phase: number }> = [];
    const npcSeeds = [
