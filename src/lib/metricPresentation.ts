...
const descriptions: Record<string, string> = {
  ...
  "leads totais meta": "Total de aquisições da Meta Ads no período: leads de formulário/site mais conversas iniciadas por anúncios.",
  "conversas iniciadas meta": "Conversas iniciadas por anúncios Meta no período. Cada conversa também é incluída em Leads totais Meta.",
  "conversas iniciadas": "Conversas iniciadas por anúncios Meta no período. Na Análise de Funis, elas também compõem os Leads totais Meta.",
