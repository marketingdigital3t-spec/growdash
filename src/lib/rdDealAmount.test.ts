...
describe("getRDDealAmount", () => {
  ...
  it("permite exibir o preço cadastrado do produto para negociação em aberto sem valor no RD", () => {
    expect(getRDDealAmount({ amount_total: 0, amount_total_effective: null }, 1_997)).toBe(1_997);
  });
});
