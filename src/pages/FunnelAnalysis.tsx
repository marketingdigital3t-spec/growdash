    ...
    <MotionPage className="gd-module-shell gd-funnel-analysis mx-auto max-w-[1700px] space-y-5">
      ...
      {loadingFunnels || isLoading || loadingMetaActions || loadingPeriodDeals || loadingClosedDeals || loadingPeriodClosedDeals || loadingStages || loadingPeriodSales ? (
        ...
        <>
          ...
          <MotionItem>
            <FunnelAudienceProfile deals={operationalPeriodDeals} campaignIds={audienceCampaignIds} accountIds={allAccountsSelected ? Array.from(integratedAccountIds) : selectedAccountIds} startDate={startDate} endDate={endDate} />
          </MotionItem>
