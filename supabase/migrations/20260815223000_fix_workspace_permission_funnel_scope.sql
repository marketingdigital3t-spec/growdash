-- rd_funnels belongs to a workspace through its ad account. The previous
-- workspace access writer incorrectly referenced a non-existent
-- rd_funnels.workspace_id column, causing every permission update to fail.
